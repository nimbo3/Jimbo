...
echo "echo 'java -javaagent:\$HOME/prometheus_jmx/jmx_prometheus_javaagent-0.12.0.jar=7889:\$HOME/prometheus_jmx/config.yaml -jar es-page-processor-0.0.1-SNAPSHOT.jar' > ~/es-page-processor/es-page-processor.sh;" | ssh -p $2 $1
