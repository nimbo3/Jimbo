...
echo "echo 'java -javaagent:$HOME/prometheus_jmx/jmx_prometheus_javaagent-0.12.0.jar=5678:$HOME/prometheus_jmx/config.yaml -jar crawler-0.0.1-SNAPSHOT.jar' > ~/crawler/crawler.sh;" | ssh -p $2 $1
